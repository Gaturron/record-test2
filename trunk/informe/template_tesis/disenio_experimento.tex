...
\lstset{ %
	...
	morekeywords={OrdenDeFrasesConocidas, String, ObtenerReglaConMenorPorcentaje, ObtenerLaFraseMasPonderada, Repetir, veces, Si, agregar, Recorrer, Devolver, y, RecalcularPorcentajes, esta, en, Mientras, Inout, Output},
}
\begin{lstlisting}
