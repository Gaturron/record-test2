...
\subsection*{Variando la cantidad de hablantes}
...
Nunca es bueno descartar datos pero debemos tener un conjunto de datos equilibrado para saber si utilizando los atributos que definidos podemos realizar una mejor clasificación que el baseline. Tomaremos 9 hablantes de Buenos Aires y de 8 Córdoba. En la tabla \ref{PAH_esq_cv} vemos este esquema.
...
Agregamos un hablante más de Buenos Aires ya que de esta manera cuando quitamos un hablante para testeo el algoritmo ZeroRule posee instancias equilibradas en el conjunto de entrenamiento. De esta forma es más correcto el análisis. 

De esta forma, el conjunto de datos posee sólo una unidad de diferencia entre ambos grupos. La elección de cada uno de estos hablantes fue al azar. Como el esquema anterior, tendremos un fold por cada hablante. 
...
Los resultados de este cross-validaton podemos observarlo en la tabla \ref{PAH_class_corr_en_pct}.
