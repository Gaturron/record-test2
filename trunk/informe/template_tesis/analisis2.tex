...
La extracción de atributos, su normalización y el tratamiento de los valores desconocidos fueron explicados en el capítulo \ref{extraccion}. No realizamos ningún cálculo extra para los valores desconocidos.
