...
\usepackage[spanish, es-tabla, activeacute, USenglish]{babel}
...
\input{disenio_experimento.tex}
\input{sistema_grabacion_online.tex}
\input{extraccion_de_informacion.tex}
\input{datos_obtenidos.tex}
\input{analisis2.tex}
\input{conclusiones.tex}
\input{marcas_prosodicas.tex}
\input{nomenclatura_de_atributos.tex}
