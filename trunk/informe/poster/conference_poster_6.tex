...
Definimos dos tipos de frases para realizar el experimento: \textbf{Frases comunes} y \textbf{Frases Amper}.
...
\large \textbf{Combinamos las frases}: orden de frases en un experimento 
...
\large {
La métrica utilizada es: \textbf{$\frac{ X - \mu }{ \sigma }$} donde $X$ es el valor a normalizar (por ej.: la duración de un fonema o sílaba dado). $\mu$ es el promedio de duración de la unidad utilizada en la grabación. $\sigma$ es el desvío estándar de esta unidad utilizada.
}
...
\begin{itemize}
	...
	\item \textbf{CV2 - Dejando un hablante fuera promediando los atributos: } En este esquema dejamos un hablante afuera para test y entrenamos con el resto. También equilibramos la cantidad de hablantes: 8 Buenos Aires, 8 Córdoba. 
