...
p = subprocess.Popen(
    ...
    jython analize2_xHab.py """+ sys.argv[1] +""" """+sys.argv[2]+"""
...
print 'ZeroR avg: '+ str(average(array(dataDic['rules.ZeroR'])))
print '------------------------------------------------------------------'

JRip = robjects.FloatVector(array(dataDic['rules.JRip']))
print 'JRip: '+str(JRip)
print 'JRip avg: '+ str(average(array(dataDic['rules.JRip'])))
print '------------------------------------------------------------------'

J48 = robjects.FloatVector(array(dataDic['trees.J48']))
print 'J48 '+str(J48)
print 'J48 avg: '+ str(average(array(dataDic['trees.J48'])))
print '------------------------------------------------------------------'

NaiveBayes = robjects.FloatVector(array(dataDic['bayes.NaiveBayes']))
print 'NaiveBayes '+str(NaiveBayes)
print 'NaiveBayes avg: '+ str(average(array(dataDic['bayes.NaiveBayes'])))
print '------------------------------------------------------------------'

SMO = robjects.FloatVector(array(dataDic['functions.SMO']))
print 'SMO '+str(SMO)
print 'SMO avg: '+ str(average(array(dataDic['functions.SMO'])))
