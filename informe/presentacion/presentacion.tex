...
{  
	...
	\begin{frame}
		...
		\begin{figure}[H]	
				...
				\node[anchor=south west,inner sep=0] (image) at (-0.6,1) {\includegraphics[width=0.9\textwidth]{perro-espectograma-cortado.png}};
...
%				\end{axis}
				...
				%\node [align=center,below] at (9.5,1.2+\posy) {/k/};
