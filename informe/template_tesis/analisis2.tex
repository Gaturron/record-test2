...
\begin{itemize}
	\item Validación cruzada estándar modificada para evitar grabaciones del mismo hablante en el mismo conjunto (sección \ref{grupo_de_hablantes})
	\item Validación cruzada por hablante dejando un hablante afuera (sección \ref{un_hablante_para_test_los_demas_train})
	\item Validación cruzada por hablante dejando uno afuera promediando los atributos de cada hablante y balanceando la cantidad de hablantes (sección \ref{prom_los_atributos_de_cada_hablante})
	\item Ídem anterior pero solamente promediando los atributos para valores desconocidos (sección  \ref{prom_los_atributos_de_cada_hablante_solo_si_es_desconocido}) 
\end{itemize}
