...
\footnotesize En la tabla \ref{tab:myfirstlongtable} podemos ver las marcas prosódicas de cada palabra en cada frase. La separación se realiza en sílabas y el asterisco marca donde ocurre el acento.
