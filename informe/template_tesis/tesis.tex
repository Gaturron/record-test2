...
%Search approaches include: Exhaustive, Best first,Simulated annealing,Genetic algorithm,Greedy forward selection
...
\begin{figure}[h!]
    \centerline{\includegraphics[width=0.8\textwidth]{weka-clustering} }
