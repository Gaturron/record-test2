...
\begin{figure}[H]
	\begin{center}		
		...
		\node [align=center,below] at (9,-0.5) {tiempo};
		...
		\mfccvec{-0.5}{-2.5}{Trama T1};
		\draw[blue, thick,->] (1.2,-0.55) -- (-0.5,-1.8);
		
		\mfccvec{0.8}{-2.5}{Trama T2};
		\draw[blue, thick,->] (1.6,-0.75) -- (0.8,-1.8);
		
		\mfccvec{2.1}{-2.5}{Trama T3};
		\draw[blue, thick,->] (2,-0.95) -- (2,-1.8);
		
		\mfccvec{3.4}{-2.5}{Trama T4};
		\draw[blue, thick,->] (2.4,-1.15) -- (3.4,-1.8);
		
		\node at (4.2, -2.5) {...};
		\mfccvec{5}{-2.5}{Trama TM};
		\draw[blue, thick,->] (4,-1.55) -- (5,-1.8);
		
		%resultado
		\mfccvecmax{9.2}{-2.5}{Resultado vector máximos}
		\draw[decorate,decoration={brace,amplitude=7pt}] (6,-1.8) -- (6,-3.5);
