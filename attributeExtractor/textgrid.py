...
def demo():
    ...
    print "==============================================="
    #print 'Format 1 : version hardcodeada'
    #print demo_data1_bis
    #demo_TextGrid(demo_data1_bis)
    print "==============================================="
    print "Format 1 : version file"
    file = open('/home/fernando/Tesis/Prosodylab-Aligner-master/data/bsas_u11_t11_a2.TextGrid', 'r')
...
demo_data1_bis = """File type = "ooTextFile"
Object class = "TextGrid"
